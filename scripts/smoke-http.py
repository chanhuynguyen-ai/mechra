...
with tempfile.TemporaryFile() as log:
    ...
    try:
        ...
        context={'document_type':'part','document_id':'smoke-doc','update_stamp':1}
        ...
        context['features']=[{'name':'Mechra-Plate-Extrude','type_name':'Boss'}]
        ...
        print(f"Real HTTP smoke PASS: {health['version']} build={health['build_id']}; UTF-8 clarify/create/edit, invalid input and volume checks.")
    except Exception:
