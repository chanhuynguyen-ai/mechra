...
& $output (Join-Path $root 'src\Shared\tests\verification-cases.json') (Join-Path $root 'src\Shared\tests\feature-scope-cases.json') (Join-Path $root 'src\Shared\tests\rectangle-cases.json')
